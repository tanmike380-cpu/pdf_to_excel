...
async def parse_file(
    ...
    Args:
        ...
        translation_rules: JSON dict or key=value lines for translation
    ...
    logger.info(f"Parse request: file={file.filename}, doc_type={document_type}, file_id={file_id}")
    
    response = ParseResponse()
    
    try:
        # Validate translation rules format
